...
async def business_outreach_route(payload: BusinessOutreachRequest, civic_access_token: str | None = Depends(extract_bearer_token)):
    try:
        result = await run_business_outreach(
            payload.business_id,
